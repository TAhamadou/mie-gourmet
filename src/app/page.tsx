      ...
      <main>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-6">Welcome to Mie-Gourmet</h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Indulge in our handcrafted collection of premium cakes and desserts, made with love and the finest ingredients. 
              From rich cheesecakes to decadent layer cakes, each creation is a masterpiece designed to delight your senses.
            </p>
