                ...
                {items.map((item) => (
                  <div key={item.product.id} className="flex gap-4 border-b pb-6">
                    ...
                    <div className="flex-1">
                      ...
                      {/* Show description for assortment products */}
                      {item.product.productType === 'Assortment' && item.product.description && (
                        <p className="text-sm text-gray-600 mb-2 line-clamp-3">{item.product.description}</p>
                      )}
                      
                      <p className="text-gray-900 font-medium mb-2">${item.product.price.toFixed(2)} each</p>
